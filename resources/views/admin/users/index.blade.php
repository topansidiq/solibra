    ...
    <div class="content flex flex-col flex-auto bg-gray-50 w-full">
        <div class="title p-4 flex item-center justify-between">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-cloak x-transition class="modal-add bg-white shadow-2xl rounded-lg fixed top-32 left-52 w-1/3"
                    x-show="open">
                    ...
                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Contoh: Budiono Siregar" required>
                        </div>
                        <div>
                            <label for="phone_number" class="block font-semibold">Nomor WhatsApps</label>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                class="form-input w-full border-b border-slate-400 focus: outline-0 p-2 placeholder: text-sm"
                                placeholder="Contoh: budionosiregar2025@gmail.com" required>
                        </div>
                        <div>
                            <label for="password" class="block font-semibold">Kata Sandi</label>
                ...
                <tbody class="text-xs">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="px-4 py-1 border border-slate-300 text-left">{{ $user->name }}</td>
                            <td class="px-4 py-1 border border-slate-300 text-center">
                                @if ($user->role === 'user')
                                    <span>Pengguna</span>
                                @endif
                            ...
                            <td class="px-4 py-1 border border-slate-300 text-center tracking-widest">
